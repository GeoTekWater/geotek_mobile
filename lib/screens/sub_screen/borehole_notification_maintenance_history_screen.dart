...
class BoreHoleNotificationMaintenanceHistoryScreen extends StatefulWidget {
  final Map boreHole;
  const BoreHoleNotificationMaintenanceHistoryScreen(
      {super.key, required this.boreHole});

  @override
  State<BoreHoleNotificationMaintenanceHistoryScreen> createState() =>
      _BoreHoleNotificationMaintenanceHistoryScreenState();
}

class _BoreHoleNotificationMaintenanceHistoryScreenState
    extends State<BoreHoleNotificationMaintenanceHistoryScreen> {
